[{
	...
	"label-auto-update-available": "A new version of the app is available. Do you want to download the update now? You may continue working while the update is downloaded in the background.",
	"label-auto-update-available-title": "Autographa Lite Update Available",
	"update-error-title": "Auto-update error",
	"update-unavailable-msg" : "Autographa Lite is up to date",
	"update-unavailable-title" : "Auto-update Unavailable",
	"label-update-downloaded": "A newer version of Autographa Lite has finished downloading. Do you want to install the update now? Otherwise, the update would be installed when you restart the application.",
	"label-install-updates": "Install Updates",
	"label-install-restart" : "Install and Restart",
	"confirm-internet-access": "Confirm Internet Access",
	"internet-access-desc": "Enabling auto-update would allow Autographa Lite to connect to the internet to check for updates during the start of the application. Are you sure you want to proceed?",
	"btn-check-for-update": "Check for updates now",
	"btn-checking-for-update": "Checking...",
	"btn-dwnloading-update": "Update downloading...",
	"btn-update-downloaded": "Update downloaded",
