[{
	...
	"label-auto-update" : "Actualización automática",
	"label-auto-update-available": "Una nueva versión de la aplicación está disponible. ¿Desea descargar la actualización ahora? Puede continuar trabajando mientras la actualización se descarga en segundo plano.",
	"label-auto-update-available-title": "Actualización Autographa Lite disponible",
	"update-error-title": "Error de actualización automática",
	"update-unavailable-msg" : "Autographa Lite está actualizado",
	"update-unavailable-title" : "Actualización automática no disponible",
	"label-update-downloaded": "Se terminó de descargar una versión más reciente de Autographa Lite. ¿Desea instalar la actualización ahora? De lo contrario, la actualización se instalará cuando reinicie la aplicación.",
	"label-install-updates": "Instalar actualizaciones",
	"label-install-restart" : "Instalar y reiniciar",
	"confirm-internet-access": "Confirmar el acceso a Internet",
	"internet-access-desc": "Al habilitar la actualización automática, Autographa Lite se conectará a Internet para buscar actualizaciones durante el inicio de la aplicación. ¿Estas seguro que deseas continuar?",
	"btn-check-for-update": "Buscar actualizaciones ahora",
	"btn-checking-for-update": "Comprobación...",
	"btn-dwnloading-update": "Actualización de descarga...",
	"btn-update-downloaded": "Actualización descargada",
