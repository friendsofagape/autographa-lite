[{
	...
	"dynamic-compare-mode" :  "El modo de comparación no es significativo en diferentes idiomas. Asegúrese de haber configurado los detalles de la traducción en Configuración y seleccionado el mismo idioma en todos los paneles.",
	...
	"label-imported-book": "Libro importado con éxito",
	"label-importing": "Importador...",
	"label-sign-in" : "Registrarse",
	"label-sigining": "Iniciando sesión...",
	"label-signin-issue": "Hubo un problema al intentar iniciar sesión en Paratext. Asegúrese de que el nombre de usuario y la contraseña sean correctos y que su dispositivo esté conectado a Internet antes de volver a intentarlo",
	"username-req": "Se requiere nombre de usuario",
	"password-req": "se requiere contraseña",
	"label-sync": "Sincronización",
