[{
	...
	"label-auto-update" : "التحديث التلقائي",
	"label-auto-update-available": "يتوفر إصدار جديد من التطبيق. هل تريد تنزيل التحديث الآن؟ يمكنك متابعة العمل أثناء تنزيل التحديث في الخلفية.",
	"label-auto-update-available-title": "تحديث Autographa لايت المتاحة",
	"update-error-title": "خطأ التحديث التلقائي",
	"update-unavailable-msg" : "Autographa Lite محدثة",
	"update-unavailable-title" : "التحديث التلقائي غير متوفر",
	"label-update-downloaded": "انتهت نسخة أحدث من Autographa Lite من التنزيل. هل تريد تثبيت التحديث الآن؟ خلاف ذلك ، سيتم تثبيت التحديث عند إعادة تشغيل التطبيق.",
	"label-install-updates": "تثبيت التحديثات",
	"label-install-restart" : "تثبيت وإعادة التشغيل",
	"confirm-internet-access": "تأكيد الوصول إلى الإنترنت",
	"internet-access-desc": "سيسمح تمكين التحديث التلقائي Autographa Lite بالاتصال بالإنترنت للتحقق من وجود تحديثات أثناء بدء التطبيق. هل انت متأكد انك تريد المتابعة؟",
	"btn-check-for-update": "تحقق من وجود تحديثات الآن",
	"btn-checking-for-update": "تدقيق...",
	"btn-dwnloading-update": "تحديث التنزيل...",
	"btn-update-downloaded": "تحديث تحميلها",
