[{
	...
	"label-auto-update-available-title": "تحديث أوتوغرافا لايت المتاحة",
	"update-error-title": "خطأ التحديث التلقائي",
	"update-unavailable-msg" : "أوتوغرافا ليت محدثة",
	"update-unavailable-title" : "التحديث التلقائي غير متوفر",
	"label-update-downloaded": "انتهت نسخة أحدث من أوتوغرافا ليت من التنزيل. هل تريد تثبيت التحديث الآن؟ خلاف ذلك ، سيتم تثبيت التحديث عند إعادة تشغيل التطبيق.",
	...
	"internet-access-desc": "سيسمح تمكين التحديث التلقائي أوتوغرافا ليت بالاتصال بالإنترنت للتحقق من وجود تحديثات أثناء بدء التطبيق. هل انت متأكد انك تريد المتابعة؟",
