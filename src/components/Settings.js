    ...
    Promise.map(inputPath, file => {
      ...
      if (fs.statSync(file).isFile() && !file.startsWith(".")) {
        ...
        return this.getStuffAsync(options)
          ...
          .catch(err => {
            console.log(err);
            var errorpath = `${appPath}/report/error${date.getDate()}${date.getMonth() +
              1}${date.getFullYear()}.log`;
  ...
  importReference = () => {
    ...
    var ref_id_value =
      ...
      files = fs.readdirSync(
        Array.isArray(refFolderPath) ? refFolderPath[0] : refFolderPath
      );
        ...
        >
          ...
          <div>
            ...
            >
              ...
              >
                <Modal.Body
                  className={this.state.successTitle ? "ImportedFiles" : ""}
                  ...
                  {this.state.warningFile.map((_warning, key) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <ExpansionPanelDetails style={{ boxShadow: "0" }}>
                          <Typography>
              ...
              >
                <Modal.Body
                  className={this.state.errorTitle ? "ErrorFiles" : ""}
                >
                  <div
                    style={{ position: "absolute", top: "-4px", right: "39px" }}
                  >
