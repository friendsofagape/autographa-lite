...
class SearchModal extends React.Component {
  ...
  constructor(props) {
    ...
    handleOption = (value) => {
    	AutographaStore.replaceOption = value;
    }
  ...
  render (){
    ...
    return (  
      ...
      <Modal show={AutographaStore.showModalSearch} onHide={closeSearch} id="tab-search">
        ...
        <Modal.Body>
          <FormGroup >
            <RadioButtonGroup valueSelected= {AutographaStore.replaceOption} onChange={(event, value) => {this.handleOption(value)}} name="SearchAndReplace" style={{display: "flex", marginBottom:"2%"}}>
              <RadioButton
                value="chapter"
